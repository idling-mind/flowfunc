...
#' @export
dashFlume <- function(id=NULL, comments=NULL, config=NULL, context=NULL, default_nodes=NULL, disable_pan=NULL, disable_zoom=NULL, double_clicked_node=NULL, editor_status=NULL, initial_scale=NULL, nodes=NULL, nodes_status=NULL, selected_nodes=NULL, space_to_pan=NULL, style=NULL, type_safety=NULL) {
